            ...
            if (animateAlphaProgressView) {
                animator =
                        ObjectAnimator.ofFloat(
                                finalProgressView, View.ALPHA, finalProgressView.getAlpha(), 0f);
            } else {
                    ...
                    public boolean onPreDraw() {
                        ...
                        for (int i = 0; i < n; i++) {
                            ...
                            if (child != finalProgressView
                                    && position >= finalFrom - 1
                                    && listAlphaItems.get(position, null) == null) {
                                ...
                                int delay =
                                        (int) ((s / (float) listView.getMeasuredHeight()) * 100);
