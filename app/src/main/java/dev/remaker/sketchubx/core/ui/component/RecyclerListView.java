...
package dev.remaker.sketchubx.core.ui.component;
...
import dev.remaker.sketchubx.core.util.LocaleController;
...
public class RecyclerListView extends RecyclerView {
    ...
    public class FastScroll extends View {
        ...
        private void updateColors() {
            inactiveColor =
                    type == LETTER_TYPE
                            ? ColorKt.resolveColor(getContext(), R.attr.colorSurface)
                            : ColorUtils.setAlphaComponent(Color.BLACK, (int) (255 * 0.4f));
            activeColor = ColorKt.resolveColor(getContext(), R.attr.colorPrimary);
            paint.setColor(inactiveColor);

            if (type == LETTER_TYPE) {
                letterPaint.setColor(ColorKt.resolveColor(getContext(), R.attr.colorOnSurface));
            } else {
                letterPaint.setColor(ColorKt.resolveColor(getContext(), R.attr.colorOnPrimary));
            }
            invalidate();
        }
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (type == LETTER_TYPE) {
                ...
                paint.setColor(ColorKt.resolveColor(getContext(), R.attr.colorOnSurface));
                canvas.save();
                canvas.translate(
    ...
    public RecyclerListView(Context context) {
        ...
        colorBackground = ColorKt.resolveColor(getContext(), android.R.attr.colorBackground);
