...
public class GestureDetectorFixDoubleTap {
    ...
    static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl {
        ...
        /**
         * True when the user is still touching for the second tap (down, move, and up events). Can
         * only be true if there is a double tap listener attached.
         */
        ...
        /**
         * Creates a GestureDetector with the supplied listener. You may only use this constructor
         * from a UI thread (this is the usual situation).
         *
        ...
        /**
         * Set whether longpress is enabled, if this is enabled when a user presses and holds down
         * you get a longpress event and nothing further. If it's disabled the user can press and
         * hold down and then later moved their finger and you will get scroll events. By default
         ...
         * the {@link OnGestureListener} supplied.
         *
                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    if (mIsLongpressEnabled) {
                        ...
                        mHandler.sendEmptyMessageAtTime(
                                LONG_PRESS,
                                mCurrentDownEvent.getDownTime() + TAP_TIMEOUT + mLongpressDuration);
                    }
                    mHandler.sendEmptyMessageAtTime(
    ...
    /**
     * Creates a GestureDetectorCompat with the supplied listener. As usual, you may only use this
     * constructor from a UI thread.
     *
     * @see android.os.Handler#Handler()
     * @param context the application's context
     * @param listener the listener invoked for all the callbacks, this must not be null.
     ...
     */
    public GestureDetectorFixDoubleTap(
            Context context, OnGestureListener listener, Handler handler) {
     ...
     * Sets the listener which will be called for double-tap and related gestures.
     *
     * @param listener the listener invoked for all the callbacks, or null to stop listening for
     *     double-tap gestures.
     */
