...
package dev.remaker.sketchubx.ui.components;
...
import dev.remaker.sketchubx.util.LocaleController;
...
public class RecyclerListView extends RecyclerView {
    ...
    @SectionsType private int sectionsType;
    ...
    static {
        ...
        try {
            notSoFinalInitializeScrollbars =
                    android.view.View.class.getDeclaredMethod(
                            "initializeScrollbars", TypedArray.class);
    ...
    public abstract static class FastScrollAdapter extends SelectionAdapter {
        ...
        public abstract void getPositionForScrollProgress(
                RecyclerListView listView, float progress, int[] position);
        ...
        public float getScrollProgress(RecyclerListView listView) {
            return listView.computeVerticalScrollOffset()
                    / ((float) getTotalItemsCount() * listView.getChildAt(0).getMeasuredHeight()
                                ...
                                new DiffUtil.Callback() {
                                    ...
                                    public boolean areItemsTheSame(
                                        ...
                                        return Objects.equals(
                                                oldHashes.get(oldItemPosition),
                                                hashes.get(newItemPosition));
                                    }
    ...
    public class FastScroll extends View {
        ...
        public FastScroll(Context context, int type) {
            ...
            if (type == LETTER_TYPE) {
                ...
                paint2.setColor(colorBackground);
                fastScrollBackgroundDrawable =
                        ContextCompat.getDrawable(context, R.drawable.calendar_date).mutate();
                fastScrollBackgroundDrawable.setColorFilter(
                        new PorterDuffColorFilter(
                                ColorUtils.blendARGB(colorBackground, Color.WHITE, 0.1f),
            ...
            scrollX =
                    isRtl
                            ...
                            : AndroidUtilities.dp((type == LETTER_TYPE ? 132 : 240) - 15);
            updateColors();
            setFocusableInTouchMode(true);
            ViewConfiguration vc = ViewConfiguration.get(context);
            touchSlop = vc.getScaledTouchSlop();
            fastScrollShadowDrawable =
                    ContextCompat.getDrawable(context, R.drawable.fast_scroll_shadow);
        }

        private void updateColors() {
            inactiveColor =
                    type == LETTER_TYPE
                            ? ColorExtensionsKt.resolveColor(getContext(), R.attr.colorSurface)
                            : ColorUtils.setAlphaComponent(Color.BLACK, (int) (255 * 0.4f));
            activeColor = ColorExtensionsKt.resolveColor(getContext(), R.attr.colorPrimary);
            paint.setColor(inactiveColor);

            if (type == LETTER_TYPE) {
                letterPaint.setColor(ColorExtensionsKt.resolveColor(getContext(), R.attr.colorOnSurface));
            } else {
                letterPaint.setColor(ColorExtensionsKt.resolveColor(getContext(), R.attr.colorOnPrimary));
            }
            invalidate();
        }
                ...
                case MotionEvent.ACTION_DOWN:
                    ...
                    float currentY =
                            (float)
                                            Math.ceil(
                                                    (getMeasuredHeight()
                                                                    - AndroidUtilities.dp(24 + 30))
                                                            * progress)
                                    + AndroidUtilities.dp(12);
                    if (isRtl && x > AndroidUtilities.dp(25)
                            || !isRtl && x < AndroidUtilities.dp(107)
                            || lastY < currentY
                            || lastY > currentY + AndroidUtilities.dp(30)) {
                        return false;
                    }
                    if (type == DATE_TYPE && !floatingDateVisible) {
                        if (isRtl && x > AndroidUtilities.dp(25)
                                || !isRtl && x < (getMeasuredWidth() - AndroidUtilities.dp(25))
                                || lastY < currentY
                                || lastY > currentY + AndroidUtilities.dp(30)) {
                            return false;
                        }
            ...
            if (layoutManager instanceof LinearLayoutManager) {
                ...
                if (linearLayoutManager.getOrientation() == LinearLayoutManager.VERTICAL) {
                    ...
                    if (adapter instanceof FastScrollAdapter) {
                        ...
                        fastScrollAdapter.getPositionForScrollProgress(
                                RecyclerListView.this, progress, positionWithOffset);
                        if (updatePosition) {
                            linearLayoutManager.scrollToPositionWithOffset(
                                    positionWithOffset[0], -positionWithOffset[1] + sectionOffset);
                        }
                        ...
                        if (newLetter == null) {
                            ...
                            if (type == LETTER_TYPE) {
                                ...
                                if (outLetterLayout != null) {
                                    ...
                                    String[] oldSplits =
                                            outLetterLayout.getText().toString().split(" ");
                                    if (newSplits != null
                                            && oldSplits != null
                                            && newSplits.length == 2
                                            && oldSplits.length == 2
                                            && newSplits[1].equals(oldSplits[1])) {
                                        String oldText = outLetterLayout.getText().toString();
                                        SpannableStringBuilder spannableStringBuilder =
                                                new SpannableStringBuilder(oldText);
                                        ...
                                        spannableStringBuilder =
                                                new SpannableStringBuilder(newLetter);
                                        spannableStringBuilder.setSpan(
                                                new EmptyStubSpan(),
                                                newSplits[0].length(),
                                                newLetter.length(),
                                        ...
                                        spannableStringBuilder =
                                                new SpannableStringBuilder(newLetter);
                                        spannableStringBuilder.setSpan(
                                                new EmptyStubSpan(), 0, newSplits[0].length(), 0);
                                        stableLetterLayout =
                                                new StaticLayout(
                                                        spannableStringBuilder,
                                                        letterPaint,
                            ...
                            if (letterLayout.getLineCount() > 0) {
                                ...
                                if (isRtl) {
                                    textX =
                                            AndroidUtilities.dp(10)
                                                    + (AndroidUtilities.dp(88)
                                                                    - letterLayout.getLineWidth(0))
                                                            / 2
                                                    - letterLayout.getLineLeft(0);
                                } else {
                                    textX =
                                            (AndroidUtilities.dp(88) - letterLayout.getLineWidth(0))
                                                            / 2
                                                    - letterLayout.getLineLeft(0);
                                }
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            setMeasuredDimension(
                    AndroidUtilities.dp(type == LETTER_TYPE ? 132 : 240),
        ...
        protected void onDraw(Canvas canvas) {
            ...
            rect.set(
                    scrollX,
                    AndroidUtilities.dp(12) + y,
                    scrollX + AndroidUtilities.dp(5),
                    AndroidUtilities.dp(12 + 30) + y);
            if (type == LETTER_TYPE) {
                ...
                paint.setColor(ColorUtils.blendARGB(colorBackground, Color.WHITE, 0.1f));

                float cy = y + AndroidUtilities.dp(12 + 15);
                fastScrollShadowDrawable.setBounds(
                        getMeasuredWidth() - fastScrollShadowDrawable.getIntrinsicWidth(),
                        (int) (cy - fastScrollShadowDrawable.getIntrinsicHeight() / 2),
                        getMeasuredWidth(),
                        (int) (cy + fastScrollShadowDrawable.getIntrinsicHeight() / 2));
                fastScrollShadowDrawable.draw(canvas);
                canvas.drawCircle(
                        scrollX + AndroidUtilities.dp(8),
                        y + AndroidUtilities.dp(12 + 15),
                        AndroidUtilities.dp(24),
                        paint);

                paint.setColor(ColorExtensionsKt.resolveColor(getContext(), R.attr.colorOnSurface));
                canvas.save();
                canvas.translate(
                        scrollX + AndroidUtilities.dp(4),
                        y
                                + AndroidUtilities.dp(12 + 15 + 2 + 5)
                                + AndroidUtilities.dp(2) * bubbleProgress);
            ...
            if (type == LETTER_TYPE) {
                if ((isMoving || bubbleProgress != 0)) {
                    ...
                    if (diff <= AndroidUtilities.dp(29)) {
                        ...
                        raduisTop =
                                AndroidUtilities.dp(4)
                                        + (1.0f - diff / AndroidUtilities.dp(29))
                                                * AndroidUtilities.dp(40);
                    }
                    if (isRtl && (radii[0] != raduisTop || radii[6] != raduisBottom)
                            || !isRtl && (radii[2] != raduisTop || radii[4] != raduisBottom)) {
                        if (isRtl) {
                        ...
                        path.reset();
                        rect.set(
                                isRtl ? AndroidUtilities.dp(10) : 0,
                                0,
                                AndroidUtilities.dp(isRtl ? 98 : 88),
                                AndroidUtilities.dp(88));
                        path.addRoundRect(rect, radii, Path.Direction.CW);
                        path.close();
                    }
                    StaticLayout layoutToDraw =
                            letterLayout != null ? letterLayout : oldLetterLayout;
                ...
                if (letterLayout != null && floatingDateProgress != 0) {
                    ...
                    float x =
                            rect.left
                                    - AndroidUtilities.dp(30) * bubbleProgress
                                    - AndroidUtilities.dp(8);
                    float r = letterLayout.getHeight() / 2f + AndroidUtilities.dp(6);
                    float width =
                            replaceLayoutProgress * letterLayout.getWidth()
                                    + fromWidth * (1f - replaceLayoutProgress);
                    rect.set(
                            x - width - AndroidUtilities.dp(36),
                            cy - letterLayout.getHeight() / 2f - AndroidUtilities.dp(8),
                            x - AndroidUtilities.dp(12),
                            cy + letterLayout.getHeight() / 2f + AndroidUtilities.dp(8));
                    ...
                    fastScrollBackgroundDrawable.setBounds(
                    ...
                    if (replaceLayoutProgress != 1f) {
                        ...
                        if (outLetterLayout != null) {
                            letterPaint.setAlpha(
                                    (int)
                                            (oldAlpha2
                                                    * floatingDateProgress
                                                    * (1f - replaceLayoutProgress)));
                            canvas.save();
                            canvas.translate(
                                    x - outLetterLayout.getWidth() - AndroidUtilities.dp(24),
                                    cy
                                            - outLetterLayout.getHeight() / 2f
                                            + (fromTop ? -1 : 1)
                                                    * AndroidUtilities.dp(15)
                                                    * replaceLayoutProgress);
                        ...
                        if (inLetterLayout != null) {
                            ...
                            canvas.save();
                            canvas.translate(
                                    x - inLetterLayout.getWidth() - AndroidUtilities.dp(24),
                                    cy
                                            - inLetterLayout.getHeight() / 2f
                                            + (fromTop ? 1 : -1)
                                                    * AndroidUtilities.dp(15)
                                                    * (1f - replaceLayoutProgress));
                        ...
                        if (stableLetterLayout != null) {
                            ...
                            canvas.save();
                            canvas.translate(
                                    x - stableLetterLayout.getWidth() - AndroidUtilities.dp(24),
                                    cy - stableLetterLayout.getHeight() / 2f);
                        ...
                        canvas.save();
                        canvas.translate(
                                x - letterLayout.getWidth() - AndroidUtilities.dp(24),
                                cy
                                        - letterLayout.getHeight() / 2f
                                        + AndroidUtilities.dp(15) * (1f - replaceLayoutProgress));
            ...
            if ((isMoving && letterLayout != null && bubbleProgress < 1.0f)
                    || (!isMoving || letterLayout == null) && bubbleProgress > 0.0f) {
        ...
        public int getScrollBarY() {
            return (int) Math.ceil((getMeasuredHeight() - AndroidUtilities.dp(24 + 30)) * progress)
    ...
    private class RecyclerListViewItemClickListener implements OnItemTouchListener {
        ...
        public RecyclerListViewItemClickListener(Context context) {
            gestureDetector =
                    new GestureDetectorFixDoubleTap(
                            context,
                            new GestureDetectorFixDoubleTap.OnGestureListener() {
                                ...
                                public boolean onSingleTapUp(MotionEvent e) {
                                    if (currentChildView != null) {
                                        if (onItemClickListenerExtended != null
                                                && onItemClickListenerExtended.hasDoubleTap(
                                                        currentChildView, currentChildPosition)) {
                                ...
                                public boolean onSingleTapConfirmed(MotionEvent e) {
                                    if (doubleTapView != null
                                        ...
                                        if (onItemClickListenerExtended.hasDoubleTap(
                                                doubleTapView, currentChildPosition)) {
                                ...
                                public boolean onDoubleTap(MotionEvent e) {
                                    if (doubleTapView != null
                                            ...
                                            && onItemClickListenerExtended.hasDoubleTap(
                                                    doubleTapView, currentChildPosition)) {
                                        onItemClickListenerExtended.onDoubleTap(
                                                doubleTapView,
                                    ...
                                    if (cv != null
                                        ...
                                        if (instantClick && position != -1) {
                                            ...
                                            if (onItemClickListener != null) {
                                                ...
                                                onItemClickListenerExtended.onItemClick(
                                                        view,
                                                        position,
                                                        x - view.getX(),
                                                        y - view.getY());
                                                                            ...
                                                                            if (onItemClickListener
                                                                                ...
                                                                                onItemClickListener
                                                                                        .onItemClick(
                                                                                                view,
                                                                                                position);
                                                                            } else if (onItemClickListenerExtended
                                                                                    != null) {
                                ...
                                public void onLongPress(MotionEvent event) {
                                    if (currentChildView == null
                                            ...
                                            || onItemLongClickListener == null
                                                    && onItemLongClickListenerExtended == null) {
                                        return;
                                    }
                                    View child = currentChildView;
                                    if (onItemLongClickListener != null) {
                                        if (onItemLongClickListener.onItemClick(
                                                currentChildView, currentChildPosition)) {
                                        ...
                                        if (onItemLongClickListenerExtended.onItemClick(
                                                currentChildView,
                                                currentChildPosition,
                                                event.getX() - currentChildView.getX(),
                                                event.getY() - currentChildView.getY())) {
                                            child.performHapticFeedback(
                                                    HapticFeedbackConstants.LONG_PRESS);
                                            child.sendAccessibilityEvent(
                                                    AccessibilityEvent.TYPE_VIEW_LONG_CLICKED);
        ...
        public boolean onInterceptTouchEvent(RecyclerView view, MotionEvent event) {
            ...
            if ((action == MotionEvent.ACTION_DOWN || action == MotionEvent.ACTION_POINTER_DOWN)
                ...
                if ((allowItemsInteractionDuringAnimation
                                || animator == null
                                || !animator.isRunning())
                        && allowSelectChildAtPosition(ex, ey)) {
                ...
                if (currentChildView != null) {
                    ...
                    MotionEvent childEvent =
                            MotionEvent.obtain(
                                    ...
                                    event.getX() - currentChildView.getLeft(),
                                    event.getY() - currentChildView.getTop(),
                                    0);
            ...
            if (action == MotionEvent.ACTION_DOWN || action == MotionEvent.ACTION_POINTER_DOWN) {
                if (!interceptedByChild && currentChildView != null) {
                    ...
                    if (currentChildView.isEnabled()
                            && canHighlightChildAt(
                                    currentChildView,
                                    x - currentChildView.getX(),
                                    y - currentChildView.getY())) {
    ...
    public RecyclerListView(Context context) {
        ...
        // setGlowColor(MaterialColors.getColor(this, R.attr.colorPrimary));
        colorBackground = ColorExtensionsKt.resolveColor(getContext(), android.R.attr.colorBackground);
        selectorDrawable = ContextCompat.getDrawable(context, R.drawable.rect_selector);
    ...
    protected void drawSectionBackground(
            Canvas canvas, int fromAdapterPosition, int toAdapterPosition, int color) {
    ...
    protected void drawSectionBackgroundExclusive(
            Canvas canvas,
            int fromAdapterPositionExclusive,
            int toAdapterPositionExclusive,
            int color) {
        int top = Integer.MAX_VALUE;
        int bottom = Integer.MIN_VALUE;
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        ...
        if (fastScroll != null && fastScroll.getLayoutParams() != null) {
            ...
            fastScroll.measure(
                    MeasureSpec.makeMeasureSpec(AndroidUtilities.dp(132), MeasureSpec.EXACTLY),
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (fastScroll != null) {
            ...
            if (fastScroll.isRtl) {
                fastScroll.layout(
                        0, t, fastScroll.getMeasuredWidth(), t + fastScroll.getMeasuredHeight());
            } else {
                int x = getMeasuredWidth() - fastScroll.getMeasuredWidth();
                fastScroll.layout(
                        x,
                        t,
                        x + fastScroll.getMeasuredWidth(),
                        t + fastScroll.getMeasuredHeight());
            }
            selfOnLayout = false;
        }
        checkSection(false);
    ...
    public void setSelectorDrawableColor(int color) {
        ...
        if (selectorType == 8) {
            selectorDrawable = createRadSelectorDrawable(color, selectorRadius, 0);
        } else if (topBottomSelectorRadius > 0) {
            selectorDrawable =
                    createRadSelectorDrawable(
                            color, topBottomSelectorRadius, topBottomSelectorRadius);
        } else if (selectorRadius > 0 && selectorType != 1) {
            selectorDrawable =
                    createSimpleSelectorRoundRectDrawable(selectorRadius, 0, color, 0xff000000);
        } else if (selectorType == 2) {
            selectorDrawable = getSelectorDrawable(color, false);
        } else {
            selectorDrawable = createSelectorDrawable(color, selectorType, selectorRadius);
        }
        selectorDrawable.setCallback(this);
    }
    ...
    public static Drawable createSimpleSelectorRoundRectDrawable(
            int rad, int defaultColor, int pressedColor, int maskColor) {
        ShapeDrawable defaultDrawable =
                new ShapeDrawable(
                        new RoundRectShape(
                                new float[] {rad, rad, rad, rad, rad, rad, rad, rad}, null, null));
        defaultDrawable.getPaint().setColor(defaultColor);
        ShapeDrawable pressedDrawable =
                new ShapeDrawable(
                        new RoundRectShape(
                                new float[] {rad, rad, rad, rad, rad, rad, rad, rad}, null, null));
        pressedDrawable.getPaint().setColor(maskColor);
        ColorStateList colorStateList =
                new ColorStateList(new int[][] {StateSet.WILD_CARD}, new int[] {pressedColor});
    ...
    public static Drawable getSelectorDrawable(int color, boolean whiteBackground) {
        if (whiteBackground) {
            return getSelectorDrawable(color, colorBackground);
        } else {
    ...
    public static Drawable getSelectorDrawable(int color, int backgroundColor) {
        if (backgroundColor != 0) {
            ...
            return new RippleDrawable(
                    colorStateList, new ColorDrawable(backgroundColor), maskDrawable);
        } else {
            return createSelectorDrawable(color, 2);
        }
    }
                    ...
                    new Drawable() {
                        ...
                        public void draw(Canvas canvas) {
                            ...
                            if (maskType == 7) {
                                ...
                                canvas.drawCircle(
                                        bounds.centerX(), bounds.centerY(), rad, maskPaint);
                            }
                        }
    ...
    public void checkSection(boolean force) {
        if ((scrollingByUser || force) && fastScroll != null
                || sectionsType != SECTIONS_TYPE_SIMPLE && sectionsAdapter != null) {
            LayoutManager layoutManager = getLayoutManager();
            if (layoutManager instanceof LinearLayoutManager) {
                LinearLayoutManager linearLayoutManager = (LinearLayoutManager) layoutManager;
                if (linearLayoutManager.getOrientation() == LinearLayoutManager.VERTICAL) {
                    if (sectionsAdapter != null) {
                        ...
                        if (sectionsType == SECTIONS_TYPE_STICKY_HEADERS
                                || sectionsType == SECTIONS_TYPE_FAST_SCROLL_ONLY) {
                            ...
                            if ((scrollingByUser || force)
                                    && fastScroll != null
                                    && !fastScroll.isPressed()) {
                                Adapter adapter = getAdapter();
                                if (adapter instanceof FastScrollAdapter) {
                                    fastScroll.setProgress(
                                            Math.min(
                                                    1.0f,
                                                    firstVisibleItem
                                                            / (float)
                            ...
                            if (currentFirst != firstVisibleItem
                                ...
                                sectionsCount = 1;
                                startSection =
                                        sectionsAdapter.getSectionForPosition(firstVisibleItem);
                                int itemNum =
                                        firstVisibleItem
                                                + sectionsAdapter.getCountForSection(startSection)
                                                - sectionsAdapter.getPositionInSectionForPosition(
                                                        firstVisibleItem);
                                while (itemNum < firstVisibleItem + visibleItemCount) {
                                    itemNum +=
                                            sectionsAdapter.getCountForSection(
                            ...
                            if (currentFirst != startSection || pinnedHeader == null) {
                                ...
                                pinnedHeader.layout(
                                        0,
                                        0,
                                        pinnedHeader.getMeasuredWidth(),
                                        pinnedHeader.getMeasuredHeight());
                                currentFirst = startSection;
                            }
                            if (pinnedHeader != null
                                    && minChildSection != null
                                    && minChildSection.getClass() != pinnedHeader.getClass()) {
                            ...
                            if (adapter instanceof FastScrollAdapter) {
                                float p =
                                        ((FastScrollAdapter) adapter)
                                                .getScrollProgress(RecyclerListView.this);
                                boolean visible =
                                        ((FastScrollAdapter) adapter)
                                                .fastScrollIsVisible(RecyclerListView.this);
    ...
    public void setListSelectorColor(int color) {
        selectorDrawable =
                new RippleDrawable(
                        ColorStateList.valueOf(color), null, getRippleMask(colorBackground, 8));
    }
    ...
    public void setOnItemLongClickListener(
            OnItemLongClickListenerExtended listener, long duration) {
    ...
    private void highlightRowInternal(
            RecyclerListView.IntReturnCallback callback,
            int removeAfter,
            boolean canHighlightLater) {
        if (removeHighlighSelectionRunnable != null) {
            AndroidUtilities.cancelRunOnUIThread(removeHighlighSelectionRunnable);
            removeHighlighSelectionRunnable = null;
        }
        ...
        if (holder != null) {
            ...
            if (selectorDrawable != null) {
                ...
                if (Build.VERSION.SDK_INT >= 21) {
                    selectorDrawable.setHotspot(
                            holder.itemView.getMeasuredWidth() / 2,
            ...
            if (removeAfter > 0) {
                AndroidUtilities.runOnUIThread(
                        removeHighlighSelectionRunnable =
                                () -> {
                                    removeHighlighSelectionRunnable = null;
                                    pendingHighlightPosition = null;
                                    if (selectorDrawable != null) {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (sectionsAdapter != null
                && pinnedHeader != null
                && pinnedHeader.getAlpha() != 0
                && pinnedHeader.dispatchTouchEvent(ev)) {
            return true;
        }
    ...
    private void positionSelector(int position, View sel, boolean manageHotspot, float x, float y) {
        ...
        if (selectorType == 8) {
            selectorDrawable =
                    new RippleDrawable(
                            ColorStateList.valueOf(
                                    ColorExtensionsKt.resolveColor(getContext(), R.attr.colorControlHighlight)),
                            null,
            ...
            // 0, position == getAdapter().getItemCount() - 2 ? topBottomSelectorRadius : 0);
        }
        selectorRect.set(
                sel.getLeft(), sel.getTop(), sel.getRight(), sel.getBottom() - bottomPadding);
        ...
        if (sectionsType == SECTIONS_TYPE_STICKY_HEADERS) {
            if (sectionsAdapter != null && !headers.isEmpty()) {
                for (int a = 0; a < headers.size(); a++) {
                    ...
                    canvas.translate(
                            LocaleController.isRTL ? getWidth() - header.getWidth() : 0, top);
            ...
            if (sectionsAdapter != null && pinnedHeader != null && pinnedHeader.getAlpha() != 0) {
                ...
                canvas.translate(
                        LocaleController.isRTL ? getWidth() - pinnedHeader.getWidth() : 0, top);
                if (pinnedHeaderShadowDrawable != null) {
                    pinnedHeaderShadowDrawable.setBounds(
                            0,
                            pinnedHeader.getMeasuredHeight(),
                            getWidth(),
                            pinnedHeader.getMeasuredHeight()
                                    + pinnedHeaderShadowDrawable.getIntrinsicHeight());
    ...
    public void relayoutPinnedHeader() {
        if (pinnedHeader != null) {
            ...
            pinnedHeader.layout(
                    0, 0, pinnedHeader.getMeasuredWidth(), pinnedHeader.getMeasuredHeight());
            invalidate();
        }
    }
                        ...
                        public void requestLayout() {
                            ...
                            try {
                                ...
                                final int measuredHeight =
                                        RecyclerListView.this.getMeasuredHeight();
                                measure(
                                        MeasureSpec.makeMeasureSpec(
                                ...
                                layout(
                                        0,
                                        0,
                                        overlayContainer.getMeasuredWidth(),
                                        overlayContainer.getMeasuredHeight());
                            } catch (Exception ignored) {
                            }
                        }
                    };
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        if (multiSelectionGesture
            ...
            if (multiSelectionGestureStarted) {
                ...
                if (e.getY() > getMeasuredHeight() - AndroidUtilities.dp(56) - listPaddings[1]
                        && !(currentSelectedPosition < startSelectionFrom
                                && multiSelectionListener.limitReached())) {
                    startMultiselectScroll(false);
                } else if (e.getY() < AndroidUtilities.dp(56) + listPaddings[0]
                        && !(currentSelectedPosition > startSelectionFrom
                                && multiSelectionListener.limitReached())) {
            ...
            if (useRelativePositions) {
                ...
                if (AndroidUtilities.rectTmp.contains(x, y)) {
                    ...
                    if (currentSelectedPosition != position) {
                        boolean selectionFromTop =
                                currentSelectedPosition > startSelectionFrom
                                        || position > startSelectionFrom;
                                ...
                                if (!multiSelectionListener.limitReached()) {
                                    for (int k = currentSelectedPosition + 1; k <= position; k++) {
                                        ...
                                        if (multiSelectionListener.canSelect(k)) {
                                            multiSelectionListener.onSelectionChanged(
                                                    k, true, x, y);
                                        }
                                    }
                                }
